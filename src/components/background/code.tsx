...
export default function Waves({
    ...
    const boundingRef = useRef<BoundingElement>({width: 0, height: 0, left: 0, top: 0});
    ...
    useEffect(() => {
        ...
        function setLines() {
            ...
            // Ensure linesRef.current is always an empty array before pushing elements
            linesRef.current = [];
            ...
            for (let i = 0; i <= totalLines; i++) {
                const pts: Points[] = []; // Ensure type consistency
                ...
                // Ensure linesRef.current exists before pushing
                if (linesRef.current) {
